...
return [
    ...
    'scrawlPathFormat' => '/uploads/scrawl/{yyyy}{mm}/{yy}{mm}{dd}_{hh}{ii}{ss}_{rand:4}',  // 文件保存路径
    ...
    'snapscreenPathFormat' => '/uploads/snapscreen/{yyyy}{mm}/{yy}{mm}{dd}_{hh}{ii}{ss}_{rand:4}',  // 文件保存路径
    ...
    'catcherPathFormat' => '/uploads/image/{yyyy}{mm}/{yy}{mm}{dd}_{hh}{ii}{ss}_{rand:4}',  // 文件保存路径
    ...
    'videoPathFormat' => '/uploads/media/{yyyy}{mm}/{yy}{mm}{dd}_{hh}{ii}{ss}_{rand:4}',  // 文件保存路径
    'videoUrlPrefix' => '',  // 视频访问路径前缀
    'videoMaxSize' => 10*1024*1024,  // 上传大小限制, 单位B, 默认10MB, 注意修改服务器的大小限制
    'videoAllowFiles' => ['.flv', '.swf', '.mkv', '.avi', '.rm', '.rmvb', '.mpeg', '.mpg', '.ogg', '.ogv', '.mov', '.wmv', '.mp4', '.webm', '.mp3', '.wav', '.mid'],  // 允许上传的文件类型
